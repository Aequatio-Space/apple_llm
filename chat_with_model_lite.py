...
pipe = pipeline("text-generation", model="/Users/aequatio/147-大模型本地/sft_fine_tune", torch_dtype=torch.bfloat16, device_map="auto")
...
messages = [
    {
        "role": "system",
        "content": "You will receive a series of number with a specific pattern. Your task is to print user's input.",
    },
