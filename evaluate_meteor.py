...
def main(args):
    ...
    # 生成预测并收集结果
    for example in tqdm(data[:args.max_samples]):
    ...
    try:
        ...
        print(f"Error calculating METEOR scores: {e}")
        scores = None
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate model METEOR scores on a dataset")
